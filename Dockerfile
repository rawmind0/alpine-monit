...
ENV MONIT_VERSION=5.23.0     MONIT_HOME=/opt/monit     MONIT_URL=https://mmonit.com/monit/dist     SERVICE_VOLUME=/opt/tools     PATH=$PATH:/opt/monit/bin
...
ENTRYPOINT ["/bin/bash","-c","/bin/monit-start.sh"]
